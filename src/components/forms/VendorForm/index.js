...
const styleSheet = createStyleSheet('VendorForm', {
  content: {
    padding: '0 24px 12px',
  },
  actions: {
...
const VendorForm = ({ id, classes, handleSubmit, submitting }) => {
  return (
    <MuiPaper component={Form} onSubmit={handleSubmit} method="POST">
      <MuiToolbar>
        <MuiTypography type="headline">{id ? 'Update' : 'Create'} vendor</MuiTypography>
      </MuiToolbar>
...
export default withStyles(styleSheet)(VendorForm)
