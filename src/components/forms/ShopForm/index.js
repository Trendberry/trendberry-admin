    ...
    <MuiPaper component={Form} onSubmit={handleSubmit} method="POST">
      ...
      <div className={classes.content}>
        ...
        <Grid container spacing={24}>
          <Grid item sm={8}>
            <Field name="name" label="Name" type="text" component={TextField} />
            <Field name="description" label="Description" type="textarea" component={TextField} />
            <Field name="feedUrl" label="Feed URL" type="text" component={TextField} />
          </Grid>
          <Grid item sm={4}>
...
export default withStyles(styleSheet, {name:'ShopForm'})(ShopForm)
